...
const FAQ = () => {
    ...
    return (
        <div className='min-h-fit w-full flex justify-center bg-white pb-24 items-center flex-col p-2'>
            <div >
                <h1 className='py-2 px-8 text-2xl text-slate-800 font-regular mb-8'>FAQ</h1>
            </div>

            <div className='w-full h-fit md:w-3/4 xl:w-1/2 bg-gray-100 shadow-lg p-4 flex flex-col transition-all ease-in-out delay-150 mb-4'>
                <div className='w-full flex'>
                    <div className='w-3/4 flex items-center'>
                        <p className='text-base font-semibold hover:cursor-pointer'>Apa itu pengaduan kekerasan seksual?</p>
                    </div>
                    <div className='w-1/4 flex justify-end'>
                        <p className='text-3xl hover:cursor-pointer' onClick={() => setFAQ1(!FAQ1)}>{FAQ1 == true ? "-" : "+"}</p>
                    </div>
                </div>
                <div className={`w-full mt-8  ${FAQ1 == true ? " " : "hidden "}`}>
            ...
            <div className='w-full h-fit md:w-3/4 xl:w-1/2 bg-gray-100 shadow-lg p-4 flex flex-col transition-all ease-in-out delay-150 mb-4'>
                <div className='w-full flex'>
                    ...
                    <div className='w-1/4 flex justify-end'>
                        <p className='text-3xl hover:cursor-pointer' onClick={() => setFAQ2(!FAQ2)}>{FAQ2 == true ? "-" : "+"}</p>
                    </div>
                </div>
                <div className={`w-full mt-8  ${FAQ2 == true ? " " : "hidden "}`}>
            ...
            <div className='w-full h-fit md:w-3/4 xl:w-1/2 bg-gray-100 shadow-lg p-4 flex flex-col transition-all ease-in-out delay-150 mb-4'>
                <div className='w-full flex'>
                    ...
                    <div className='w-1/4 flex justify-end'>
                        <p className='text-3xl hover:cursor-pointer' onClick={() => setFAQ3(!FAQ3)}>{FAQ3 == true ? "-" : "+"}</p>
                    </div>
                </div>
                <div className={`w-full mt-8  ${FAQ3 == true ? " " : "hidden "}`}>
            ...
            <div className='w-full h-fit md:w-3/4 xl:w-1/2 bg-gray-100 shadow-lg p-4 flex flex-col transition-all ease-in-out delay-150 mb-4'>
                <div className='w-full flex'>
                    ...
                    <div className='w-1/4 flex justify-end'>
                        <p className='text-3xl hover:cursor-pointer' onClick={() => setFAQ4(!FAQ4)}>{FAQ4 == true ? "-" : "+"}</p>
                    </div>
                </div>
                <div className={`w-full mt-8  ${FAQ4 == true ? " " : "hidden "}`}>
            ...
            <div className='w-full h-fit md:w-3/4 xl:w-1/2 bg-gray-100 shadow-lg p-4 flex flex-col transition-all ease-in-out delay-150 mb-4'>
                <div className='w-full flex'>
                    ...
                    <div className='w-1/4 flex justify-end'>
                        <p className='text-3xl hover:cursor-pointer' onClick={() => setFAQ5(!FAQ5)}>{FAQ5 == true ? "-" : "+"}</p>
                    </div>
                </div>
                <div className={`w-full mt-8  ${FAQ5 == true ? " " : "hidden "}`}>
