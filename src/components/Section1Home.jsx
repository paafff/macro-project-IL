...
const Section1Home = () => {
    return (
        <div className='min-h-screen md:min-h-[600px] bg-[#F6F4EB] lg:min-h-screen flex flex-col md:flex-row justify-around items-center p-5 xl:p-32'>
            <div className='md:w-1/2 lg:w-1/2 md:p-5 lg:p-0 flex flex-col justify-center'>
                <div className="text lg:pl-20 lg:pb-10 mb-8">
                    <p className='text-3xl xl:text-[64px] leading-tight font-regular mb-4 xl:mb-8 text-gray-800'>Laporkan Kekerasan Seksual!</p>
                ...
                <div className="button lg:pl-20 lg:mt-0">
                    <Link className='px-8 py-4 xl:px-12 xl:py-6 rounded-md mr-3 font-semibold bg-red-700 text-white hover:bg-red-800 transition duration-200 ease-in-out shadow-md'>Lapor</Link >
