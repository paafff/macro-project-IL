        ...
        <div className='min-h-screen md:min-h-[600px] lg:min-h-screen flex flex-col md:flex-row justify-around items-center p-5 xl:p-32'>
            <div className='md:w-1/2 lg:w-1/2 md:p-5 lg:p-0 flex flex-col justify-center'>
                <div className="text lg:pl-20 lg:pb-10 mb-8">
                    <p className='text-3xl xl:text-[64px] leading-tight font-semibold mb-4 xl:mb-8 text-gray-800'>Laporkan Kekerasan Seksual!</p>
                    <p className='text-xl xl:text-2xl font-regular text-gray-800'>Website pengaduan kasus kekerasan seksual adalah platform aman untuk melaporkan insiden-insiden kekerasan seksual dan mencari bantuan serta dukungan yang diperlukan</p>
                </div>
