        ...
        <>
            {updateBioState == false ? (
                ...
                <div className='min-h-screen pt-32 flex flex-col items-start mb-16 gap-16 p-4'>
                    ...
                    <p className='w-full mx-auto transition duration-200 ease-in-out text-center py-2 rounded-md hover:bg-red-800 hover:cursor-pointer bg-red-700 text-[#F7F7F7] md:w-3/4 lg:w-1/2' onClick={() => setUpdateBioState(!updateBioState)}>Ubah Biodata</p>
                </div>
            ) : (
                ...
                <div className='min-h-screen pt-32 flex flex-col items-start mb-16 gap-16 p-4'>
                    ...
                    <p className='w-full mx-auto transition duration-200 ease-in-out text-center py-2 rounded-md bg-gray-500 hover:bg-gray-600 hover:cursor-pointer text-[#F7F7F7] md:w-3/4 lg:w-1/2' onClick={() => setUpdateBioState(!updateBioState)}>Simpan Perubahan</p>
                </div>
            )}
